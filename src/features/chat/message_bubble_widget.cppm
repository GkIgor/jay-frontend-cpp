...
public:
    ...
    void Render(jay::engine::RenderContext& ctx) const override {
        ...
        if (m_copyTimer > 0.0f) {
            ...
            ctx.DrawText("OK", {m_copyBtnRect.x + 5.0f, m_copyBtnRect.y + 4.0f}, 13.0f, jay::engine::Color{255, 255, 255, 255});
        } else {
            jay::engine::Rect backSheet{
                m_copyBtnRect.x + 9.0f,
                m_copyBtnRect.y + 4.0f,
                11.0f,
                13.0f
            };
            jay::engine::Rect frontSheet{
                m_copyBtnRect.x + 5.0f,
                m_copyBtnRect.y + 8.0f,
                11.0f,
                13.0f
            };
